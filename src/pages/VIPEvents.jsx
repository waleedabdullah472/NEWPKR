      ...
      <section className="section section-black">
        <div className="columns">
          <div className="left-column col-8">
            ...
            <p className="description">To expedite the registration process, we’ve added an invitation code in addition to an embedded registration form. Play to win thrilling prizes after enjoying a leisurely <a href="https://www.92pkr.digital/AboutUs">read </a>through of the instructions.</p>
          </div>
