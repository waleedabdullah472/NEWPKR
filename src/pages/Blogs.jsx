  ...
  return (
    <div className="vip-events">
      <Helmet>
        ...
        <link rel="canonical" href="https://www.92pkr.digital/blogs" />
      </Helmet>
      ...
      <section className="section section-black">
        <div className="columns">
          <div className="left-column col-8">
            <h1 className="heading-with-bg">Welcome to 92PKR-Blog Pakistan – Your One-Stop Shop of Excitement and Real Cash Prizes!</h1>
